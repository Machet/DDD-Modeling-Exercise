...
namespace DDDCinema.Scheduling.Tests
{
    ...
    public class MovieSchedulingTests
    {
        ...
        private void CreateSchedule(WeekNumber weekNumber = null)
        {
            ...
            schedule = new RoomSchedule(room, week);
        }

        private void ScheduleMovie(Movie movie, ClockTime clockTime)
        {
            schedule.ScheduleMovie(movie, clockTime);
        }
        ...
        private object IsSubmited(RoomSchedule schedule)
        {
            return schedule.IsSubmited;
        }
        ...
        private TimeSpan TotalLengthOfMovie(RoomSchedule schedule)
        {
            return schedule.Seances[0].TotalTime.Length;
        }
    }
}
